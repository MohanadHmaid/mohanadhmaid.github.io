...
const projects: Project[] = [
  {
    ...
    githubUrl: "https://github.com/MohanadHmaid",
    category: "web",
    featured: true,
  },
  {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`group relative bg-card border border-border rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 ${project.featured ? "md:col-span-2 lg:col-span-1" : ""
                }`}
            >
              {/* Project image */}
